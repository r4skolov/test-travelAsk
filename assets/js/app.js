...
var _fancy = _interopRequireDefault(require("./components/fancy"));
...
},{"./components/fancy":94,"./components/slider":95}],94:[function(require,module,exports){
"use strict";
...
function initSwiper() {
  var reviewsSwiper = new _bundle["default"]('.js-reviews-slider', {
    slidesPerView: 1,
    spaceBetween: 10,
    speed: 800,
    pagination: {
